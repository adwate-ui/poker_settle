...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-10 px-1 sm:px-4 truncate text-left align-middle font-semibold font-luxury text-foreground uppercase tracking-widest text-tiny sm:text-table-base [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
...
>(({ className, isNumeric, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      "p-1 sm:p-4 truncate align-middle font-medium font-body text-tiny sm:text-table-base [&:has([role=checkbox])]:pr-0 text-left",
