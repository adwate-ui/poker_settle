...
const HandReplay = ({
  ...
  }, [isPlaying, animate]); // animate includes currentActionIndex and actions in its useCallback deps
    ...
    <div className="space-y-6 animate-fade-in">
      <div className="glass-panel felt-gradient shadow-2xl p-4 rounded-2xl">
        <PokerTableView
          ...
          communityCards=""
          showAllPlayerCards={currentActionIndex === 0}
          playerStacks={playerStacks}
          showPotChips={Object.keys(streetPlayerBets).length === 0 || animateChipsToPot}
        />
      </div>
