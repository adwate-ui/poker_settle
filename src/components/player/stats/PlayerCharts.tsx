  ...
  if (totalSessions < 2) {
    return (
      <div className="p-8 rounded-xl border border-dashed border-border bg-accent/5 text-center space-y-3">
        ...
        <div>
          <p className="text-3xs uppercase font-luxury tracking-widest text-muted-foreground/40">Analytics Locked</p>
  ...
  return (
    <div className="rounded-xl border border-border bg-background/60 backdrop-blur-xl overflow-hidden shadow-sm">
      <div className="px-5 pt-5 pb-4 border-b border-border bg-accent/5">
        ...
        <p className="text-3xs uppercase font-luxury tracking-widest text-muted-foreground mt-0.5">Session performance charts</p>
      </div>
      ...
      <div className="p-4 sm:p-5">
        <Tabs defaultValue="performance">
          <TabsList className="mb-5 h-9 w-full sm:w-auto bg-accent/10 border border-border/50 p-0.5 gap-0.5">
            <TabsTrigger
              value="performance"
              className="h-8 text-3xs uppercase font-luxury tracking-widest px-3 sm:px-4 gap-1.5 data-[state=active]:bg-background data-[state=active]:shadow-sm"
            >
          ...
          <TabsContent value="performance" className="mt-0 animate-in fade-in duration-300">
            <p className="text-3xs uppercase font-luxury tracking-widest text-muted-foreground mb-3 leading-none">
